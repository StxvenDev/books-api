...
import { bookSchemaCreate, bookSchemaUpdate } from '../utils/joiValidator';
...
export class BookController{
  ...
  routes(uriBase : string, app: Application){
    app.post(`${uriBase}/`, [bodyValidator(bookSchemaCreate)], this.createBook.bind(this));
    ...
    app.patch(`${uriBase}/:id`, [bodyValidator(bookSchemaUpdate)], this.updateBook.bind(this));
